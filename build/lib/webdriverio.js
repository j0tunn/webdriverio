...
var WebdriverIO = function WebdriverIO(args, modifier) {
    ...
    var reject = function reject(err, onRejected) {
        ...
        err.shotTaken = true;
        return takeScreenshot.call(this, err).catch(function (e) {
    ...
    function takeScreenshot(err) {
        ...
        var screenshotPromise = typeof err.screenshot === 'string' ? _promise2.default.resolve(err.screenshot) : client.next(rawCommands.screenshot, [], 'screenshot').then(function (res) {
            return res.value;
        });

        return screenshotPromise.then(function (screenshot) {
